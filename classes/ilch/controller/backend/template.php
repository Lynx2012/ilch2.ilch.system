...
class Ilch_Controller_Backend_Template extends Controller_Template {
    ...
    {       
        // Run event
        Event::run('Classes_Ilch_Controller_Backend_Template::before::before', $this);
        ...
        // Run event
        Event::run('Classes_Ilch_Controller_Backend_Template::before::after', $this);
    }

    public function after()
    {
        // Run event
        Event::run('Classes_Controller_Backend_Template::after::before', $this);
        
        // Run anything that needs to run after this.
        parent::after();
        
        // Run event
        Event::run('Classes_Controller_Backend_Template::after::after', $this);
    }
